 ...
 */
@WebServlet("/UserLoginWithoutCookie.do")
public class UserLoginWithoutCookie extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserLoginWithoutCookie() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (authLevel < 1 || uid == null || uid == "")
		{
			...
			response.sendRedirect(
					response.encodeRedirectURL("/CityManagerWeb/Session/Login_sessions_no_cookie.html"));
			//*/
		}
		else
		{
			...
			//*
			response.sendRedirect(
					response.encodeRedirectURL("destinationpage.do"));
			//*/
		}
	}
