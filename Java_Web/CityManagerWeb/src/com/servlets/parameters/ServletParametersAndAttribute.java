 ...
 */
@WebServlet("/servletParametersAndAttribute.do")
public class ServletParametersAndAttribute extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletParametersAndAttribute() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html><body>"
				+ "<h1 align='center'>Results from GET MainMenuResponderTwo received...</h1>"
				+"</body></html>"
				);
	}
