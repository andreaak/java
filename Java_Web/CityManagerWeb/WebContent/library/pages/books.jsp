<%@page import="com.servlets.library.enums.SearchType"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.servlets.library.beans.Book"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>

<%@include file="../../WEB-INF/jspf/left_menu.jspf" %>

<jsp:useBean id="bookList" class="com.servlets.library.beans.BookList" scope="page"/>
...
<div class="book_list">
    ...
    <div class="book_info">
        <div class=".book_title a">
            <p> <a href="content.jsp?index=<%=list.indexOf(book)%>"><%=book.getName()%></a></p>
        </div>
        <div class="book_image">
            <a href="content.jsp?index=<%=list.indexOf(book)%>"><img src="<%=request.getContextPath()%>/showimage.do?index=<%=list.indexOf(book)%>" height="250" width="190" alt="Обложка"/></a>
        </div>
