...
<html>
    ...
    <body>
        ...
        <div class="pdf_viewer">
            <applet CODE="EmbedPDF.class" archive="<%=getServletContext().getContextPath()%>/library/jars/EmbedPDF.jar" WIDTH="850" HEIGHT="900">
                <!-- The URL of the PDF document that we want to show: -->

                <param name="pdf" value="<%= request.getContextPath()%>/pdfcontent.do?index=<%=request.getParameter("index")%>&session_id=<%=request.getSession().getId()%>"/> 
                ...
                <param name="image" value="<%=getServletContext().getContextPath()%>/library/images/splash.gif"/>
