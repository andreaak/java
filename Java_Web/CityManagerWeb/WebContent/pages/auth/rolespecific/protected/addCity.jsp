...
<c:set var="suff" value="/pages/auth/rolespecific/" />	
...
<body>
	...
	<c:choose>
		<c:when test="${sessionScope.countryCodes eq null}">
			<jsp:forward page="/getcountrycodes.do?suff=${suff}&suff2=protected/" />
		</c:when>
		<c:otherwise>
	...
	<table style="width:100%;">
		<tr>
			...
			<td style="width:75%;height:80%;">
				<form action="${pageContext.request.contextPath}/protected/addnewcity.do?suff=${suff}&suff2=protected/" method="post">
					<table border=1> 
						<tr>
							<td>ID</td>
							<td>
