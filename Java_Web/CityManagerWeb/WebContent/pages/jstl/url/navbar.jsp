...
<c:url value="/signout.do?suff=/pages/jstl/url/" var="signoutController" />
<c:url value="/invalidatesessionandremovecookies.do?suff=/pages/jstl/url/" var = "invalidateSessionRemoveCookiesURL" />
